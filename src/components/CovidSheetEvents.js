...
const CovidSheet = (props) => {
  console.log("show covid sheet");
  useEffect(function () {
    if (props.showCovidSheet) {
  ...
  return (
    <>
      {console.log(
        markerLink,
        typeof String(markerLink),
        "https://reactjs.org/logo-og.png",
        typeof "https://reactjs.org/logo-og.png"
      )}
